  ...
  if (!orgId) {
    return (
      <main className="mx-auto max-w-3xl px-6 py-16 text-center">
        <p className="text-slate-600">Select an organization to view its documents.</p>
      </main>
    )
  }
    ...
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      {docs.length === 0 ? (
        <div className="rounded-xl border border-dashed border-slate-300 p-10 text-center">
          ...
          <Link href="/app" className="mt-2 inline-block text-sm font-medium text-slate-900 underline">
            ...
            <li key={doc.id}>
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-medium text-slate-900">{doc.source}</span>
